...
The documentation is organized by topic and workflow. For a quick start, begin with [quick start guide](./quickstart.mdx). For technical deep-dives, see the compression technique folders.
